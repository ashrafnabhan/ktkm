...
head. The pharmacological regimen was revised to include LMWH,
...
{[}10--12{]}. The present case thus represents the fourth documented
...
previously reported cases {[}10--12{]}, she exhibited the hallmark triad
...
amplifying risks of thromboembolism and hemorrhage {[}{[}13{]}{]}.
...
that of a previously published case report {[}12{]}, in which
...
all three previously reported cases {[}10--12{]}, the neonate
...
two of the three previously reported cases {[}10,11{]}. Corticosteroid
...
treatment {[}10--12{]}. The patient was discharged on day ten and
...
in women with KTS. The published cross-sectional data {[}13{]}
